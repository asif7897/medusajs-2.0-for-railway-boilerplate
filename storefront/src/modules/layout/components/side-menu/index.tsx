...
import { Arrow, Arrow2 } from '@modules/layout/components/Icons/index'
          ...
          {({ open, close }) => (
            <>
              <div className="relative flex h-full">
                <Popover.Button className="poppins relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none hover:text-white">
                  Menu
                </Popover.Button>
              </div>
                                ...
                                <div key={subIndex} className={''}>
                                  <ul>
                                    <li><LocalizedClientLink
                                      href={`/categories/${subMenu.handle}`}
